<?php
class sehipe extends WP_Widget {

	 function __construct() {
		$widget_ops = array('classname' => 'yegi_yazma', 'description' =>  "تور بېتىڭىزدىكى سەھىپىلەر." );
		parent::__construct('sehipe', '«مەنزىل» | سەھىپىلەر', $widget_ops);
	}
...
add_action('widgets_init', create_function('', 'return register_widget("sehipe");'));?>